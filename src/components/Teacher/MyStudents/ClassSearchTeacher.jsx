...
import { languageLevels, studentGrid } from '../../../data/gridHeaders'
...
import ClassAdd from '../../Admin/Monitor/Classes/ClassAdd'

const ClassSearchTeacher = ({setOpenFilter, searchPost, setSearchParams, searchParams}) => {
  ...
  export default ClassSearchTeacher;