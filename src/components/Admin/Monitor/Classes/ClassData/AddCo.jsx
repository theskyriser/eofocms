...
import { GridComponent, ColumnsDirective } from "@syncfusion/ej2-react-grids";
...
const AddCo = ({ setAddCo, handleCoSubmit, currentColor }) => {
        ...
        <div className="px-5 z-10">
          <div className="w-full bg-white rounded-lg shadow-lg p-4">
            <div className="mb-5 flex justify-between items-center">
              <h1 className="text-2xl"> Add Co-Ordinator to Class </h1>
            ...
            >
              <div className="grid grid-cols-5 gap-2">
                ...
                <div className="col-start-1 text-xl mb-2 col-span-3 flex justify-evenly flex-col mt-2 md:col-span-1">
                  <button
                    type="submit"
