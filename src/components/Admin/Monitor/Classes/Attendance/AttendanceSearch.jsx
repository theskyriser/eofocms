...
const AttendanceSearch = ({setOpenFilter, searchPost, setSearchParams, searchParams, handleKeyPress}) => {
         ...
         <div className='px-5 z-10'>
          <div className='w-full bg-white rounded-lg shadow-lg p-4'>
            ...
            <AnimatePresence intial={false} exitBeforeEnter={true} onExitComplete={(() => null)}>
                {addTeacher && 
                    <AttendanceAdd type="teacher" toggle={setAddTeacher} grid={teacherGrid} title="Select Teacher" handleFilterSubmit={handleFilterSubmit}/>
                }

                {addCoor && 
                    <AttendanceAdd type="coor" toggle={setAddCoor} grid={teacherGrid} title="Select Co-ordinator" handleFilterSubmit={handleFilterSubmit}/>
                }


                {addStudent && 
                    <AttendanceAdd type="student" toggle={setAddStudent} grid={studentGrid} title="Select Student" handleFilterSubmit={handleFilterSubmit}/>
                }
