              ...
              <div className="mb-5 flex justify-between items-center ">
                ...
                <TooltipComponent content="Menu" position="BottomCenter">
                  <button
                    type="button"
                    onClick={() => {
                      setActiveCredentials((prev) => !prev);
                    }}
              ...
              <div className="w-full">
                <form onSubmit={(e) => handleSubmitUpdate(e)}>
                  <div className="flex flex-col justify-center m-5 b p-2 items-center">
                    <div className="md:grid p-1 grid-cols-3 gap-2 flex flex-col md:items-left items-center">
                      <p className="text-xl col-start-1">New Password:</p>
                      <input
                        onChange={(e) => {}}
                        type="text"
                        className="border-1 border-color bg-main-bg text-xl rounded-md col-span-2"
                      ></input>
                      <p className="text-xl col-start-1">Confirm Password:</p>
                      <input
                        onChange={(e) => {}}
                        type="text"
                        className="border-1 border-color bg-main-bg text-xl rounded-md col-span-2"
