  ...
  useEffect(() => {
    dispatch(
      getTeacherTodayOverview(
        `overviewteacher?teacher=${user?.result?._id}&searchDateStart=${firstDay}&searchDateEnd=${lastDay}`
      )
    );
  }, []);
      ...
      <div className=" bg-main-bg rounded-lg shadow-lg p-4">
        ...
        <div className="md:grid grid-cols-4 gap-10 flex flex-col">
          ...
          <div className="shadow-lg bg-yellow-400 p-8 rounded-sm">
            <div className="flex justify-between">
              <h2 className="text-4xl font-bold mb-4">
                {overviewData.todaysStudents ? overviewData.todaysStudents : 0}
              </h2>
              <div className="text-5xl" style={{ color: "white" }}>
                <MdOutlinePersonOutline />
              </div>
          ...
          <div className="shadow-lg bg-green-400 p-8 rounded-sm">
            <div className="flex justify-between">
              <h2 className="text-4xl font-bold mb-4">
                {" "}
                ${overviewData.todaysPay ? overviewData.todaysPay : 0}{" "}
              </h2>
              <div className="text-5xl" style={{ color: "white" }}>
                <MdAttachMoney />
              </div>
            ...
            <h3 className="font-semibold text-lg"> Expected Pay For Today </h3>
          </div>
        </div>
