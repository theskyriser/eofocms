...
import { getStudents, deleteStudent } from "../../../redux/actions/students";
  ...
  return (
    <div>
      <div className="p-4 md:mt-0 mt-10">
        <div className=" bg-main-bg rounded-lg shadow-lg p-4">
          ...
          <div className="md:grid grid-cols-7 gap-4 flex flex-col">
            <div className="col-span-3 bg-white rounded-lg shadow-lg p-5 flex gap-4 md:flex-row flex-col">
              <div className="items-center md:items-left flex flex-col justify-between">
                ...
                <button
                  className="py-2 px-4 rounded-md mt-5 md:mt-10 flex justify-between w-full hover:shadow-md"
          ...
          <div className="md:grid grid-cols-4 gap-8 flex flex-col">
            <div className="col-start-1 col-span-1 shadow-lg bg-white gap-4 mt-5 p-4 flex flex-col justify-evenly">
              ...
              <button
                class="py-2 px-4 rounded-md flex justify-between w-ful hover:shadow-mdl"
                onClick={() => handleAdd()}
                style={{ backgroundColor: currentColor, color: "white" }}
              >
            ...
            <div className="col-start-2 col-span-1 shadow-lg bg-white gap-4 mt-5 p-4 flex flex-col justify-evenly ">
              ...
              <button
                class="py-2 px-4 rounded-md flex justify-between w-full hover:shadow-md"
                onClick={() => handleSeeLatest()}
                style={{ backgroundColor: "#097CD3", color: "white" }}
              >
            ...
            {/* possible render bug with sparkline, investigate*/}
      ...
      >
        ...
        {activeAddStudent && (
          <AddStudent
            setActiveAddStudent={setActiveAddStudent}
        ...
        {openLatestHomework && (
          <ShowLatestHomework
            selectedStudent={selectedStudent}
            currentColor={currentColor}
            setOpenLatestHomework={setOpenLatestHomework}
          />
        )}
        ...
        {openAllHomework && (
          <SeeAllHomeworks
            selectedStudent={selectedStudent}
            currentColor={currentColor}
            setOpenAllHomework={setOpenAllHomework}
          />
        )}
      </AnimatePresence>
    </div>
